...
ใช้ในการจัดการพวกเกรียนไม่อนุญาติให้ใช้ยิงคนอื่นไปทั่ว
	...
	print("การใช้งาน พิมพ์ คำสั่ง python alifecity.py")
	print("พิมพ์คำสั่งเสร็จแล้ว อย่าพึ่งกดอะไรต่อ ให้ เว้นวรรค พิมพ์เบอร์ (000-000-0000)")
	print("เสร็จแล้ว ให้เว้นวรรค อีกรอบ ตามด้วย จำนวน SMS ที่ต้องการจะส่ง")
	sys.exit(1)
